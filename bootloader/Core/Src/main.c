...
void go2app(void)
{
	...
	//if(((*(uint32_t*) FLASH_APP_ADDR) & 0x2FFE0000) == 0x20000000) // 0x20024000
	if(((*(uint32_t*) FLASH_APP_ADDR) != 0xFFFFFFFF)) //TODO improve this
	{
		printf("APP Start ...\r\n");
		HAL_Delay(100);
